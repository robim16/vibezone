    ...
    >
      ...
      <input 
        {...register("postPhoto", {
          validate: (value) => {
            if (
              typeof value === "null" || (Array.isArray(value) && value.length === 0) 
              || value === "undefined"
            ) 
      ...
      <div>
        ...
        <textarea {...register("caption", { required: "Caption is required",
          validate: (value) => {
            if (value.length < 3) {
          ...
          id="caption"
          type="text" rows={3} placeholder="What´s on your mind" 
      ...
      <div>
        <label htmlFor="tag" className="text-light-1">Tag</label>
        <input {...register("tag", { required: "Tag is required",
          })} 
          type="text" 
          placeholder="#tag" 
